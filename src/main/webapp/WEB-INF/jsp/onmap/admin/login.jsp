...
<script type="text/javascript">
	location.href = "/onmap/admin/main.do";
</script>
</sec:authorize>
<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
<html>
	<head>
		<title>${globalConfig['config.trendOn.title']} 관리자</title>
 		<link rel="shortcut icon" type="image/x-icon" href="/images/common/favicon.ico" />
 		<link rel="stylesheet" type="text/css" href="/css/reset.css?ver=${globalConfig['config.version']}" />
 		<link rel="stylesheet" type="text/css" href="/css/admin.css?ver=${globalConfig['config.version']}" />
 		...
 		<style type="text/css">
			...
			.content { 	
			  ...
			  overflow: auto;
			  padding:15px;
			   box-shadow: 5px 5px 3px #3c4963;
			}
			.content p {text-align:center;padding:20px;line-height:1;}
			.content p span {float:left;font-size:14px;}
			.content p strong{font-size:21px; font-weight:bold;}
 		...
 		<div class="adminWrap">
			<div class="content">
				<form id="userLoginForm"  method="post" >
					...
					<p><img src="/images/common/logo2.png" alt="Trend-ON"><strong> 관리자</strong></p>
					<p>
