...
$(document).ready(function() {
	...
	var mega_list = '${param.mega_list}';    // 기관 아이디 
	var cty_list = '${param.cty_list}';    // 기관 아이디 
	
	var mega_list_arr = mega_list.split(','); 
	var cty_list_arr = cty_list.split(',');
	var initRm = '';
	
	for(var i=0; i<mega_list_arr.length; i++){
		initRm += mega_list_arr[i] + ' - ' + cty_list_arr[i] + '\n';
	}
	$('#rm').text(initRm)
