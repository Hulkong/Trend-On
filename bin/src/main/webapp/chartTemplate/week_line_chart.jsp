	...
	function drawChart(options) {
		...
		$.ajax({
			...
			success: function(json) {
				var jChartArrCuYear = json['rpt-evntEff-005-007'][0]; //입력 기간 데이터 
				var jChartArrBeYear = json['rpt-evntEff-005-008'][0]; //전년 기간 데이터 
...
// 				for (var colName in jChartArrBeYear) {
// 					if(colName != 'year' && colName != 'rate' ){
// 						chartData.push({
// 							xcol: colName,
							
// 							xcolkr: columKr[columOrder.indexOf(colName)], //x 컬럼의 한글명
// 							xcolorder: columOrder.indexOf(colName), //정렬을 위한 시퀀스
							
// 							ycol1Name: ycol1Name,
// 							ycol1valu: (jChartArrCuYear == null) ? 0 : jChartArrCuYear[colName] , 
							
// 							ycol2Name: ycol2Name,
// 							ycol2valu: (jChartArrBeYear == null) ? 0 : jChartArrBeYear[colName]
// 						});
// 					}
// 				}
	...
	function actionChart() {
		...
		var yAxis = d3.svg.axis()
		              ...
		              .tickFormat(function(d, i){
		            	  if(i > 0) return getIndexNumber(d, true) +"원";
		            	  else return "";
		              })
		              .tickPadding(10);
