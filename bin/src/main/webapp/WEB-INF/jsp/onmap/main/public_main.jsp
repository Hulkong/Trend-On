...
// 					paddingBottom: "33px",
	...
	<body>
		<div id="wrap">
			<!-- header -->
			<div id="mainHeader2">
				<h1 class="logo"><a href="#firstPage"><img src="/images/hdlogo.png" alt="logo" /></a></h1>
				<div class="gnb">
					<ul>
				...
				<div id="nav">
					<ul>
						<li class="menu1"><a href="#thirdPage">경제 24시</a></li>
						<li class="menu2"><a href="#fourthPage">경제 트렌드</a></li>
			...
			<hr />
			<div class="top_btn">
				<a href="#firstPage" id="goTop" style="display:none;"><img src="/images/top_btn.png" alt="GO TO TOP!!"></a>
			</div>
			<!-- 본문 ==================================================================================================== -->
			<!--  -->
			<div id="fullpage2">
				...
				<article class="section" id="section1">
					<div class="inner">
						...
						<a href="#none" id="btnApply" class="apy_btn">사용 신청하기</a>
					</div>
				</article>
				<!-- //section1 -->
				<!--gif-->
				...
				<article class="section" id="section2">
					<div class="inner">
						<p class="tit_sub">24hours</p>
						<h2 class="tit">경제 24시</h2>
						<p class="txt">우리 지역의 하루는 어떻게 흘러갈까요? <br />데이터를 통해 우리 지역의 진짜 모습을 발견할 수 있습니다.<br /><br /><em>시간대별로 소비가 활발한 지역을<br />한눈에 파악</em> 할 수 있습니다.</p>
					</div>
				</article>
				<!-- //section2 -->
